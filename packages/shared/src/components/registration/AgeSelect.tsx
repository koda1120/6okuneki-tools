...
import type { AgeSelectProps, AgeRange } from '../../types/registration';
import { AGE_OPTIONS } from '../../constants/config';

export function AgeSelect({ value, onChange, accentColor }: AgeSelectProps) {
  return (
      ...
      <div className="relative">
        <select
          ...
          onChange={(e) => {
            ...
            if (val) onChange(val as AgeRange);
          }}
